...
config = {
    ...
    "observations": ['agentview_image', 'agentview_depth'], #The keys to pass into GymWrapperRGBD, None if not RGBD
...
if __name__ ==  '__main__':
    ...
    if config["observations"] is not None:
        ...
        env = DummyVecEnv([lambda : Monitor(GymWrapper(suite.make(**config["env_params"])))])
